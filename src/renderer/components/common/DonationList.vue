    ...
    <div class="donors-list px-4">
      <div class="flex items-center justify-between mb-4 px-1">
        <h4 class="text-lg font-bold text-gray-900 dark:text-white flex items-center gap-2">
          <i class="ri-user-heart-line text-[var(--accent-color)]"></i>
          {{ t('donation.title') }}
        </h4>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
        ...
        >
          <div
            class="h-full bg-white dark:bg-neutral-800/50 border border-gray-100 dark:border-gray-800 rounded-xl p-3 flex gap-3 hover:border-[var(--accent-color)]/30 hover:shadow-md hover:bg-white dark:hover:bg-neutral-800 transition-all duration-300"
          >
            <!-- 澶村儚 -->
            ...
            <div class="flex-1 min-w-0 flex flex-col justify-center">
              <div class="flex justify-between items-center">
                ...
                <span class="text-xs font-mono text-[var(--accent-color)]/80 bg-[var(--accent-color)]/5 px-1.5 py-0.5 rounded">
                  楼{{ donor.amount }}
                </span>
              </div>
...
const AVATAR_COLORS = [
  ...
  'bg-green-100 text-[var(--accent-color-dark)] dark:bg-green-900/30 dark:text-[var(--accent-color)]',
