...
const grittyConfig = ref<Pick<LyricConfig, 'grittyVerticalStretch' | 'grittyScale' | 'grittyFontWeight' | 'grittyCustomFont' | 'grittyShowRedKeywords' | 'grittyKeywordColorMode' | 'grittyKeywordCustomColor'>>({
