    ...
    >
      ...
      <div v-show="activeTab === 'display'" class="space-y-2 pt-2">
        ...
        <div class="radio-group">
          <label class="radio-label">播放器样式</label>
          <div class="space-y-2">
            <label class="radio-item">
              <input type="radio" v-model="config.playerStyle" value="default" class="radio-input" />
              <span>默认</span>
            </label>
            <label class="radio-item">
              <input type="radio" v-model="config.playerStyle" value="classic" class="radio-input" />
              <span>经典</span>
            </label>
            <label class="radio-item">
              <input type="radio" v-model="config.playerStyle" value="stage" class="radio-input" />
              <span>舞台</span>
            </label>
          </div>
        </div>
        <div v-if="config.playerStyle === 'stage'" class="radio-group">
